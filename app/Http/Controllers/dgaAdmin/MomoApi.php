...
class MomoApi extends Controller
{
    ...
    private $URLAction = array(
        ...
        "REFRESH_TOKEN_MSG" => "https://api.momo.vn/auth/fast-login/refresh-token",
    ...
    public function REFRESH_TOKEN_MSG($data)
    {
        $proxy = $data['proxy'];
        $microtime = $this->get_microtime();
        $header = array(
        ...
        $Data = array(
            ...
            'extra' =>
                array(
                    ...
                    'checkSum' => $this->generateCheckSum('REFRESH_TOKEN_MSG', $microtime, $data),
                ),
                'appVer' => $this->momo_data_config["appVer"],
                'appCode' => $this->momo_data_config["appCode"],
            'lang' => 'vi',
        ...
        return $this->CURL("REFRESH_TOKEN_MSG", $header, $Data, $proxy);
    }
