                        ...
                        <div class="card card-rounded">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận
                                                doán số </label>
                                            <input type="text" class="form-control form-control-alt" name="ratioDoan"
                                                   value="{{ $setting->ratioDoan }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Nội dung đoán số </label>
                                            <input type="text" class="form-control form-control-alt" name="contentDoan"
                                                   value="{{ $setting->contentDoan }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center py-sm-3 py-md-5" >
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận tam hoa</label>
                                            <input type="number" class="form-control form-control-alt" name="amount3Same"
                                                   value="{{ $setting->amount3Same }}">
                                        </div>
                                    </div>
    
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận tứ quý</label>
                                            <input type="number" class="form-control form-control-alt" name="amount4Same"
                                                   value="{{ $setting->amount4Same }}">
                                        </div>
                                    </div>
    
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận ngũ quý</label>
                                            <input type="number" class="form-control form-control-alt" name="amount5Same"
                                                   value="{{ $setting->amount5Same }}">
                                        </div>
                                    </div>
    
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận sảnh 3</label>
                                            <input type="number" class="form-control form-control-alt" name="amount3Lobby"
                                                   value="{{ $setting->amount3Lobby }}">
                                        </div>
                                    </div>
    
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận sảnh 4</label>
                                            <input type="number" class="form-control form-control-alt" name="amount4Lobby"
                                                   value="{{ $setting->amount4Lobby }}">
                                        </div>
                                    </div>
    
                                    <div class="col-sm-3">
                                        <div class="mb-4">
                                            <label class="form-label" for="block-form1-username"> Tiền nhận sảnh 5</label>
                                            <input type="number" class="form-control form-control-alt" name="amount5Lobby"
                                                   value="{{ $setting->amount5Lobby }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
