        ...
        <div class="content">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class=" text-white fs-5">Tổng nhận: {{ number_format($total['amountReceiveToday']) }} đ</div>
                        <div class=" text-white fs-5">Tổng trừ: {{ number_format($total['amountSendToday']) }} đ</div>
                        <div class=" text-white fs-5">Doanh thu: {{ number_format($total['amountProfitToday']) }} đ</div>
                    </div>
                </div>
                </div> 
                <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class=" text-white fs-5">Tổng nhận: {{ number_format($total['amountReceiveLastDay']) }} đ</div>
                        <div class=" text-white fs-5">Tổng trừ: {{ number_format($total['amountSendLastDay']) }} đ</div>
                        <div class=" text-white fs-5">Doanh thu: {{ number_format($total['amountProfitLastDay']) }} đ</div>
                    </div>
                </div>
                </div>    
                <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class=" text-white fs-5">Tổng nhận: {{ number_format($total['amountReceive']) }} đ</div>
                        <div class=" text-white fs-5">Tổng trừ: {{ number_format($total['amountSend']) }} đ</div>
                        <div class=" text-white fs-5">Doanh thu: {{ number_format($total['amountProfit']) }} đ</div>
                    </div>
                </div>
                </div>
            </div>
