                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title fs-3 fw-bold">Kiểm tra Giao dịch</div>
                            </div>

                            <form action="{{ route('admin.checkTranById') }}" method="POST">
                                @csrf
                                <div class="card-body p-9">
                                    <div class="row mb-8">
                                        ...
                                        <div class="col-xl-9 fv-row">
                                            <select class="form-select" id="phoneSend" name="phone">
                                                @foreach ($GetAccountMomo as $row)
                                                    <option value="{{ $row->phone }}">{{ $row->phone }} - {{ $row->display_name }} -
                                    ...
                                    <div class="row mb-8">
                                        ...
                                        <div class="col-xl-9 fv-row">
                                            <input type="text" class="form-control form-control-solid" id="tranId"
                                                name="tranId" placeholder="Nhập vào Mã GD">
                                        </div>
                                    </div>
                                </div>
